 ...
 * Used to access the Webshopemails table with JOOQ type safe operations via the
 * R2DBC driver in a reactive fashion.
 *
 * @author G. Amaro
 */
@Log
...
public class WebshopemailsRepository
    implements com.optiply.infrastructure.data.repositories.interfaces.IWebshopemailsRepository {
